...
* раздел **Присоединенные документы** имеет свои права доступа, никак не связанные с правами в разделах, к котором присоединены документы;
...
### Добавление раздела
На форме добавления администратор выбирает раздел системы, в котором необходимо добавить возможность присоединения файлов; Далее необходимо указать таблицу раздела. Если указанный раздел имеет деление прав доступа по каталогам и/или по юридическим лицам необходимо также указать поля таблицы, соответствующие атрибутам каталога иерархии и/или юридического лица.
